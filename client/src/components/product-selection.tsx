    ...
    <div className="min-h-screen bg-gradient-to-br from-charcoal via-gray-900 to-black p-8 pb-16 overflow-y-auto">
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-8">
        {products?.map((product, index) => (
          ...
          >
            <Card 
              className={`transition-all duration-300 touch-target flex-1 flex flex-col ${
                selectedProduct?.id === product.id
                  ? 'ring-2 ring-luxe-gold bg-white/20 border-luxe-gold/50'
                  : 'bg-white/10 border-luxe-gold/30 hover:bg-white/20'
              ...
              <CardContent className="p-6 flex-1 flex flex-col">
                ...
                <div className="flex-1 flex flex-col">
                  ...
                  <div className="border-t border-luxe-gold/30 pt-4">
                    <p className="text-center text-platinum text-sm mb-3">Number of Sprays</p>
                    <div className="flex items-center justify-center space-x-3">
                      <Button
                        variant="outline"
                        size="sm"
                        className="w-8 h-8 rounded-full border-luxe-gold/50 hover:border-luxe-gold hover:bg-luxe-gold/20 text-white p-0"
                        onClick={(e) => {
                          e.stopPropagation();
                      ...
                      <span className="text-xl font-bold text-luxe-gold min-w-[2rem] text-center">
